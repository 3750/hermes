...
class DefaultSuccessHandlerTest extends Specification {
    ...
    private DefaultSuccessHandler handler = new DefaultSuccessHandler(offsetQueue, Stub(MetricsFacade), trackers, subscription.qualifiedName, subscription.getMetricsConfig())
